...
import * as arcContract from "../../jsonBases/functionsPermissionsArc.json";
import { modifierNamesArc } from "../../helpers/constants";

const OUTPUT_FILE = "../../out/PERMISSIONS_ARC.md";
...
async function main() {
  ...
  for (const modifier of modifierNamesArc) {
    for (const contract of arcContract) {
      let firstTime = true;
